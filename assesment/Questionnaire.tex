...
make the requirements explicit through software contracts which are
part of the specification, implementation, and testing of the code,
but we do poorly on formally developing the requirements, reviewing
them, and basing our plans on them.
\end{KPAComment}
...
suspect these are inappropriate for managing software research
