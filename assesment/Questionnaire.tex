...
\Activity{2}{2}{2}{The use of the organization's software process
...
\Activity{2}{2}{2}{Training for the organization's and projects' software
...
maintained.}
\Activity{1}{1}{1}{The organization's software process database is
...
groups we work with.}
\Results{As a result of our inablility to obtain the cooperation of
...
We are keenly aware of our verificiation obligations; we feel that
X-CI is responsible for validation.  Hence KPAs 2 and 4 are not
applicable to us.
\end{KPAComment}
\end{document}
