...
#
# valgrind like options - https://clang.llvm.org/docs/AddressSanitizer.html '-g -fsanitize=address
# -fno-omit-frame-pointer' must use clang++ for linking suppressions:
# LSAN_OPTIONS=suppressions=MyLSan.supp human readable:
...
if(NOT CXX_FLAGS_INITIALIZED)
  ...
  if(DEFINED CMAKE_CXX_COMPILER_WRAPPER AND "${CMAKE_CXX_COMPILER_WRAPPER}" STREQUAL "CrayPrgEnv")
    ...
    # Work around for broken ftn + CC linking (Redmine #1323) that results in > ld.lld: error:
    # corrupt input file: version definition index 0 for symbol mpiprivc_ is out > of bounds
