...
class Cycle_Data:
    """Contains one cycle of Milagro output data.

    Parses data from a given file-like object"""
...
class Milagro_Data:
    ...
    """Parses milagro output. Stores the results as a list of
    Cycle_Data objects. Also records the execution time."""
...
##            raise RunTimeError, "Could not find timing data"
    ...
    def gnuplot_output(self, file_out):
        ...
        """Write all of the cycle data in a form suitable for reading
