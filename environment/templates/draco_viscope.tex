...
\begin{center}
  \begin{threeparttable}
    ...
    \begin{tabular}{|p{4.5cm}|c|c|p{4.5cm}|} 
      \hline
      & Problem or        &  &  \\
      Factor             &  Dilemma\tnote{a} & Strategy\tnote{b} & Comments \\ 
      \hline\hline
    ...
    \item[a] \footnotesize{Is the critical success factor a problem or a
        ...
        and revisit it later.}
    \item[b] \footnotesize{How will you deal with the critical success
        factor? (1) Resolve it now, (2) Factor into Plan, (3) Change
        Vision/Scope, or (4) Other.}
    \item[c] The source of a critical success factor is one of: Business,
