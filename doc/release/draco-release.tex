...
Thus, releases of a particular code are shipped using an appropriate
...
bug fix to \texttt{c4-1\_9\_0} that is in \draco\ version
\texttt{draco-1\_4\_0}.  A branch is generated at this release as
...
We have explained the release policies and procedures for \draco\ 
projects in group XTM.  As with all \draco\ policies, exceptions to
