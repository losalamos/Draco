...
The purpose of this memo is to outline the release procedures for
\draco\ and \draco\ packages.  These procedures should also apply to
\draco-modeled code projects including \solon\ and \milagro.  The
essence of releasing a code product is tagging the {\bf cvs} version
of the source code.  Thus, releases of a particular code are
simply shipped by using an appropriate \texttt{cvs export} command.
