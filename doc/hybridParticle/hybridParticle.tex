...
represent implicit absorption. Particles which reach a fractional
energy weight of 0.01 are stopped and immediately switched to analog
absorption behavior. This prevents the appearence of particles with
very low fractional energy weights. If large numbers of these
particles go into the census the combing process can fail to produce a
reasonable selection of particles, resulting in considerable energy
loss. When particles are at 1\% of their original energy weight, a
cross section is computed for absorption and the energy weight of the
