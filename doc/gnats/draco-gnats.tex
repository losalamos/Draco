...
kinds. Such might include: documentation bugs, requests for a changes in behavior,
requests for additional features, things-to-do, and support problems or questions.
