...
To produce documentation, checkout a working copy of \draco\ 
and configure normally as described in  Ref~\cite{draco-build}. Then
execute the following commands in your build directory:
\begin{verbatim} 
     cd draco/autodoc
     gmake 
\end{verbatim}
...
Documentation will also be produced as part of a normal build
from the top level \texttt{draco} directory. 
