 ...
 * \note   Copyright © 2002-2010 Los Alamos National Security, LLC. All rights
 *         reserved. 
 */
//---------------------------------------------------------------------------//
// $Id$
...
void runTest()
{
    ...
    rtt_mesh_element_test::test_tri_3(elem_defs[3]);
    rtt_mesh_element_test::test_tri_6(elem_defs[4]);
    rtt_mesh_element_test::test_quad_4(elem_defs[5]);
    rtt_mesh_element_test::test_quad_8(elem_defs[6]);
    rtt_mesh_element_test::test_quad_9(elem_defs[7]);
    rtt_mesh_element_test::test_tetra_4(elem_defs[8]);
    rtt_mesh_element_test::test_tetra_10(elem_defs[9]);
    rtt_mesh_element_test::test_pyra_5(elem_defs[10]);
    rtt_mesh_element_test::test_pyra_14(elem_defs[11]);
    rtt_mesh_element_test::test_penta_6(elem_defs[12]);
    rtt_mesh_element_test::test_penta_15(elem_defs[13]);
    rtt_mesh_element_test::test_penta_18(elem_defs[14]);
