...
class nmi_float : public NML_Item {
  ...
  public:
    ...
    String Type() const { return "float"; }
};
...
class nmi_double : public NML_Item {
  ...
  public:
    ...
    String Type() const { return "double"; }
};
...
class nmi_int_set : public NML_Item {
  ...
  public:
    ...
    String Type() const { return "int_set"; }
    virtual String Choices() const;
};
...
class nmi_int_array : public NML_Item {
  ...
  public:
    ...
    String Type() const { return "int_array"; }
};
...
class nmi_DynArray_int : public NML_Item {
  ...
  public:
    ...
    String Type() const { return "DynArray<int>"; }
};
...
class nmi_PageBreak : public NML_Item {
  public:
    ...
    String Type() const { return "PageBreak"; }
};
...
class nmi_BoxStart : public NML_Item {
  public:
    ...
    String Type() const { return "BoxStart"; }
};
...
class nmi_BoxEnd : public NML_Item {
  public:
    ...
    String Type() const { return "BoxEnd"; }
};
