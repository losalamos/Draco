...
class DummyOdfmgOpacity : public rtt_cdi::OdfmgOpacity
{
    ...
    const std::string dataDescriptor;          // "DummyOdfmgOpacity"
    const std::string energyPolicyDescriptor;  // "Odfmg"

    const size_t numTemperatures;     // = 3
    const size_t numDensities;        // = 2
    const size_t numGroupBoundaries;  // = 4
    const size_t numBandBoundaries;   // = 5
  ...
  public:
     ...
     * DummyOdfmgOpacity object is destroyed.
     */
    ~DummyOdfmgOpacity( ) { };
