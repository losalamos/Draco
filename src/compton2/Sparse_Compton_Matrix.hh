//----------------------------------*-C++-*-----------------------------------//
/*!
 * \file   compton2/Sparse_Compton_Matrix.hh
 * \author Andrew Till
 * \date   22 May 2020
...
#ifndef rtt_compton2_Sparse_Compton_Matrix_hh
#define rtt_compton2_Sparse_Compton_Matrix_hh
...
/*!
 * \example compton2/test/tSparse_Compton_Matrix.cc
 *
...
class Sparse_Compton_Matrix {
    ...
    Sparse_Compton_Matrix(size_t num_points,
                          size_t num_groups,
                          size_t num_leg_moments,
                          size_t data_len);
    ...
    // x := matrix * x
    void matvec(std::vector<double> & x,
    ...
    size_t get_highest_leg_moment() const
    {
        return num_leg_moments_ - 1U;
    }
    ...
    bool check_class_invariants() const {
        bool all_good =
            ...
            (data_.size() >= num_points_ * num_groups_ * num_leg_moments_) &&
            true;
        return all_good;
    }
...
#endif // rtt_compton2_Sparse_Compton_Matrix_hh

//----------------------------------------------------------------------------//
// End compton2/Sparse_Compton_Matrix.hh
//----------------------------------------------------------------------------//
