//----------------------------------*-C++-*-----------------------------------//
/*!
 * \file   compton2/Sparse_Compton_Matrix.cc
 * \author Andrew Till
 * \date   11 May 2020
...
Sparse_Compton_Matrix::Sparse_Compton_Matrix(size_t num_points,
                                             size_t num_groups,
                                             size_t num_leg_moments,
                                             size_t data_len):
    num_points_(num_points),
    num_groups_(num_groups),
    num_leg_moments_(num_leg_moments),
    first_groups_(num_points * num_groups, 0U),
    indexes_(num_points * num_groups + 1U, 0U),
    data_(data_len, 0.0)
{
...
void Sparse_Compton_Matrix::matvec(std::vector<double> & x,
...
//----------------------------------------------------------------------------//
// End compton2/Sparse_Compton_Matrix.cc
//----------------------------------------------------------------------------//
