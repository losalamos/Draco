...
typedef void Model(vector<double> const &x,
                   vector<double> const &a,
                   double &y,
                   vector<double> &dyda);

void model(vector<double> const &x,
           vector<double> const &a,
           double &y,
           vector<double> &dyda)
{
...
//            sig.push_back(1.0);
    ...
    cout << "Optimum 1-var is " << sqrt(copt/y.size())
    ...
    cout << "Optimum 2-var is " << sqrt(copt/y.size())
    ...
    cout << "Optimum 3-var is " << sqrt(copt/y.size())
    ...
    cout << "Optimum 7-var is " << sqrt(copt/y.size())
         << " for variables " << i1 << i2 << i3 << i4 << i5 << i6 << i7
         << endl;
