...
class TestApp 
{
     ...
     * of TestApp objects, inorder to perform its functions.
     */
    ...
    /*!
     * The static theSPTestApp smart pointer is an attempt to enforce
  ...
  private:
     ...
     * For Example, if MyTestApp is derived from TestApp, then in MyTestApp.cc
     * (ignoring namespaces)...

     * SP<TestApp> TestApp::create(int &argc, char *argv[], ostream& os_in)
     * {
     *    return SP<TestApp>(new MyTestApp(argc, argv, os_in));
     * }
     */
