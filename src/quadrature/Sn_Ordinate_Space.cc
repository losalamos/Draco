 ...
 *           additional ordinate is added that is opposite in direction to the starting direction. 
 *           This is used to implement reflection exactly in curvilinear coordinates. In 1D 
 *           spherical, that means an additional angle is added at mu=1. In axisymmetric, that 
