...
typedef rtt_imc::Particle<MT,G>       GP;
typedef rtt_imc::Particle<MT,MG>      MGP;
...
void gray_cdi_mat_state_test()
{
    ...
    SP<OS_Builder>              mb(new OS_Builder(parser));
    SP<OS_Mesh>                 mesh = mb->build_Mesh();
    SP<IMC_CDI_Interface<GP> >  interface(new IMC_CDI_Interface<GP>());
...
void mg_cdi_mat_state_test()
{
    ...
    SP<OS_Builder>               mb(new OS_Builder(parser));
    SP<OS_Mesh>                  mesh = mb->build_Mesh();
    SP<IMC_CDI_Interface<MGP> >  interface(new IMC_CDI_Interface<MGP>());
