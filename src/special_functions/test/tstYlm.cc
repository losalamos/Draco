...
void comparecPlk( unsigned const l,    int   const k,
                  double   const x,    double const expVal,
...
void compareNormYlk( unsigned const l, int const k,
...
void compareRealYlk(unsigned const l, int const k,
                    double const theta, double const phi,
                    double const expVal, rtt_dsxx::UnitTest & ut )
{
    using rtt_dsxx::soft_equiv;
