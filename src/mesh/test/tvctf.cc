...
//---------------------------------------------------------------------------//
// This program tests the MT::vctf container as a model of a Vertex
// Centered MTField.
//---------------------------------------------------------------------------//
...
// The following class exists only to test the MT::vctf container with a
...
//---------------------------------------------------------------------------//
// Test the MT::vctf container according to the Forward Container
// requirements.
//---------------------------------------------------------------------------//

typedef Mesh_XYZ MT;
typedef MT::vctf<double> X;
typedef MT::vctf<int> XI;
typedef MT::vctf<long> XL;
typedef MT::vctf<DoubleContainer> XDC;
...
int main( int argc, char *argv[] )
{
    ...
    cout << "Initiating test of the MT:vctf container.\n";
...
// Print the status of the test.
    ...
    if (passed) 
    {
        cout << "**** MT::vctf Container Self Test: PASSED ****" << endl;
    }
    else
    {
        cout << "**** MT::vctf Container Self Test: FAILED ****" << endl;
    }
    cout <<     "***********************************************" << endl;
    cout << endl;

    cout << "Done testing MT::vctf container.\n";
