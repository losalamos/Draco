...
//---------------------------------------------------------------------------//
// This program tests the MT::nctf container as a model of a Node
// Centered MTField.
//---------------------------------------------------------------------------//
...
// The following class exists only to test the MT::nctf container with a
...
//---------------------------------------------------------------------------//
// Test the MT::nctf container according to the Forward Container
// requirements.
//---------------------------------------------------------------------------//

typedef Mesh_XYZ MT;
typedef MT::nctf<double> X;
typedef MT::nctf<int> XI;
typedef MT::nctf<long> XL;
typedef MT::nctf<DoubleContainer> XDC;
...
int main( int argc, char *argv[] )
{
    ...
    cout << "Initiating test of the MT:nctf container.\n";
...
// Print the status of the test.
    ...
    if (passed) 
    {
        cout << "**** MT::nctf Container Self Test: PASSED ****" << endl;
    }
    else
    {
        cout << "**** MT::nctf Container Self Test: FAILED ****" << endl;
    }
    cout <<     "***********************************************" << endl;
    cout << endl;

    cout << "Done testing MT::nctf container.\n";
