...
//---------------------------------------------------------------------------//
// This program tests the MT::bstf container as a model of a Boundary
// Specified MTField.
//---------------------------------------------------------------------------//
...
// The following class exists only to test the MT::bstf container with a
...
//---------------------------------------------------------------------------//
// Test the MT::bstf container according to the Forward Container
// requirements.
//---------------------------------------------------------------------------//

typedef Mesh_XYZ MT;
typedef MT::bstf<double> X;
typedef MT::bstf<int> XI;
typedef MT::bstf<long> XL;
typedef MT::bstf<DoubleContainer> XDC;
...
int main( int argc, char *argv[] )
{
    ...
    cout << "Initiating test of the MT:bstf container.\n";
...
// Print the status of the test.
    ...
    if (passed) 
    {
        cout << "**** MT::bstf Container Self Test: PASSED ****" << endl;
    }
    else
    {
        cout << "**** MT::bstf Container Self Test: FAILED ****" << endl;
    }
    cout <<     "***********************************************" << endl;
    cout << endl;

    cout << "Done testing MT::bstf container.\n";
