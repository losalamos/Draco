...
//---------------------------------------------------------------------------//
// This program tests the Mat4 container as a model of a Random Access
// Container.
//---------------------------------------------------------------------------//
...
// The following class exists only to test the Mat4 container with a
...
//---------------------------------------------------------------------------//
// Test the Mat4 container according to the Random Access Container
// requirements.
//---------------------------------------------------------------------------//

typedef rtt_dsxx::Mat4<double> X;
typedef rtt_dsxx::Mat4<DoubleContainer> XDC;
...
void t1()
{
    ...
    // Container concept, but we need to get an object somehow.
        ...
        X x(2, 2, 2, 2, value), w(2, 2, 2, 3, value + 1.);
    ...
    // Container concept, but we need to get an object somehow.
        ...
        X x(2, 2, 2, 2, value), y(2, 2, 2, 3, value + 1.),
          z(2, 2, 2, 4, value + 2.);
    ...
    // Container concept, but we need to get an object somehow.
        ...
        X x(2, 2, 2, 2, value), y(2, 2, 2, 2, value),
          v(2, 2, 2, 3, value + 1.), w(2, 2, 2, 3, value + 1.);
        const X cx(2, 2, 2, 2, value);
...
void t2()
{
...

    {
        ...
        DoubleContainer dcarray[16] =
          {dc, dc, dc, dc, dc, dc, dc, dc, dc, dc, dc, dc, dc, dc, dc, dc};

    // The following constructor is not required by the Random Access
    // Container concept, but we need to get an object somehow.

        XDC x(dcarray, 2, 2, 2, 2);
...
// Print the status of the test.
    ...
    if (passed) 
    {
        cout << "**** Mat4 Container Self Test: PASSED ****" << endl;
    }
    else
    {
        cout << "**** Mat4 Container Self Test: FAILED ****" << endl;
    }
    cout <<     "******************************************" << endl;
    cout << endl;

    cout << "Done testing Mat4 container.\n";
