...
//---------------------------------------------------------------------------//
// This program tests the Mat3 container as a model of a Random Access
// Container.
//---------------------------------------------------------------------------//
...
// The following class exists only to test the Mat3 container with a
...
//---------------------------------------------------------------------------//
// Test the Mat3 container according to the Random Access Container
// requirements.
//---------------------------------------------------------------------------//

typedef rtt_dsxx::Mat3<double> X;
typedef rtt_dsxx::Mat3<DoubleContainer> XDC;
...
void t1()
{
    ...
    // Container concept, but we need to get an object somehow.
        ...
        X x(2, 2, 2, value), w(2, 2, 3, value + 1.);
    ...
    // Container concept, but we need to get an object somehow.
        ...
        X x(2, 2, 2, value), y(2, 2, 3, value + 1.), z(2, 2, 4, value + 2.);
    ...
    // Container concept, but we need to get an object somehow.
        ...
        X x(2, 2, 2, value), y(2, 2, 2, value),
          v(2, 2, 3, value + 1.), w(2, 2, 3, value + 1.);
        const X cx(2, 2, 2, value);
...
void t2()
{
...

    {
        ...
        DoubleContainer dcarray[8] = {dc, dc, dc, dc, dc, dc, dc, dc};
...

    {
        ...
        double darray[8] = {0, 1, 2, 3, 4, 5, 6, 7};
...
int main( int argc, char *argv[] )
{
    ...
    cout << "Initiating test of the Mat3 container.\n";
...
// Print the status of the test.
    ...
    if (passed) 
    {
        cout << "**** Mat3 Container Self Test: PASSED ****" << endl;
    }
    else
    {
        cout << "**** Mat3 Container Self Test: FAILED ****" << endl;
    }
    cout <<     "******************************************" << endl;
    cout << endl;

    cout << "Done testing Mat3 container.\n";
