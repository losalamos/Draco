...
//---------------------------------------------------------------------------//
// This program tests the Mat2 container as a model of a Random Access
// Container.
//---------------------------------------------------------------------------//
...
// The following class exists only to test the Mat2 container with a
...
//---------------------------------------------------------------------------//
// Test the Mat2 container according to the Random Access Container
// requirements.
//---------------------------------------------------------------------------//
...
void t1()
{
    ...
    // Container concept, but we need to get an object somehow.
        ...
        X x(2, 3, value), y(3, 4, value + 1.), z(4, 5, value + 2.);
    ...
    // Container concept, but we need to get an object somehow.
        ...
        X x(2, 3, value), y(2, 3, value),
          v(3, 4, value + 1.), w(3, 4, value + 1.);
        const X cx(2, 3, value);
...
void t2()
{
...

    {
        ...
        DoubleContainer dcarray[6] = {dc, dc, dc, dc, dc, dc};
...
int main( int argc, char *argv[] )
{
    ...
    cout << "Initiating test of the Mat2 container.\n";
...
// Print the status of the test.
    ...
    if (passed) 
    {
        cout << "**** Mat2 Container Self Test: PASSED ****" << endl;
    }
    else
    {
        cout << "**** Mat2 Container Self Test: FAILED ****" << endl;
    }
    cout <<     "******************************************" << endl;
    cout << endl;

    cout << "Done testing Mat2 container.\n";
