...
void test_ctor()
{
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same h."
	    << endl << "\tdefault.h() = "
	    << std::setprecision(16) << pc_def.h()
	    << " != si.h() = " << std::setprecision(16) 
	    << pc_si.h() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same R."
	    << endl << "\tdefault.R() = "
	    << std::setprecision(16) << pc_def.R()
	    << " != si.R() = " << std::setprecision(16) 
	    << pc_si.R() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same k."
	    << endl << "\tdefault.k() = "
	    << std::setprecision(16) << pc_def.k()
	    << " != si.k() = " << std::setprecision(16) 
	    << pc_si.k() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same e."
	    << endl << "\tdefault.e() = "
	    << std::setprecision(16) << pc_def.e()
	    << " != si.e() = " << std::setprecision(16) 
	    << pc_si.e() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same c."
	    << endl << "\tdefault.c() = "
	    << std::setprecision(16) << pc_def.c()
	    << " != si.c() = " << std::setprecision(16) 
	    << pc_si.c() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same sigma."
	    << endl << "\tdefault.sigma() = "
	    << std::setprecision(16) << pc_def.sigma()
	    << " != si.sigma() = " << std::setprecision(16) 
	    << pc_si.sigma() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same G."
	    << endl << "\tdefault.G() = "
	    << std::setprecision(16) << pc_def.G()
	    << " != si.G() = " << std::setprecision(16) 
	    << pc_si.G() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same F."
	    << endl << "\tdefault.F() = "
	    << std::setprecision(16) << pc_def.F()
	    << " != si.F() = " << std::setprecision(16) 
	    << pc_si.F() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same mu0."
	    << endl << "\tdefault.mu0() = "
	    << std::setprecision(16) << pc_def.mu0()
	    << " != si.mu0() = " << std::setprecision(16) 
	    << pc_si.mu0() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same epsi0."
	    << endl << "\tdefault.epsi0() = "
	    << std::setprecision(16) << pc_def.epsi0()
	    << " != si.epsi0() = " << std::setprecision(16) 
	    << pc_si.epsi0() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same me."
	    << endl << "\tdefault.me() = "
	    << std::setprecision(16) << pc_def.me()
	    << " != si.me() = " << std::setprecision(16) 
	    << pc_si.me() << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Default and SI objects do not have same mp."
	    << endl << "\tdefault.mp() = "
	    << std::setprecision(16) << pc_def.mp()
	    << " != si.mp() = " << std::setprecision(16) 
	    << pc_si.mp() << "." << endl;
	FAILMSG(msg.str());
    }
...
void test_scaled_values()
{
    ...
    {
	ostringstream msg;
	msg << "Scaled Planck constant is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.planck()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Scaled Gas constant is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.gasConstant()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Scaled Boltzmann constant is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.boltzmann()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Scaled electron charge is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.electronCharge()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Scaled speed of light is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.speedOfLight()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
	...
	* pow( si.T() / us.T(), 4 );
    ...
    {
	ostringstream msg;
	msg << "Scaled Stefan-Boltzmann constant is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.stefanBoltzmann()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    dev = dev * us.f()/si.f() / pow( us.L()/si.L(), 2 )
	/ pow( us.M()/si.M(), 2 );
    ...
    {
	ostringstream msg;
	msg << "Scaled Gravitaitonal constant is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.gravitationalConstant()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Scaled Acceleration from Gravity is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.accelerationFromGravity()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Scaled Faraday constant is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.faradayConstant()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Scaled Permeability of vacuum (free space) is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.permeabilityOfVacuum()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    dev = 1.0 / pc.permeabilityOfVacuum()
	/ pow( pc.speedOfLight(), 2 );
    ...
    {
	ostringstream msg;
	msg << "Scaled PERMITTIVITY OF FREE SPACE (F/M) is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.permittivityOfFreeSpace()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Scaled Electron mass is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.electronMass()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << "Scaled Proton mass is not correct."
	    << endl << "\tvalue =  "
	    << std::setprecision(16) << pc.protonMass()
	    << " != " << std::setprecision(16) 
	    << dev << "." << endl;
	FAILMSG(msg.str());
    }
