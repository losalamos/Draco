...
void test_ctor()
{
	...
	{
	    ostringstream msg;
	    msg << "Conversion Value for X4 UnitSystem is correct."
		<< endl;
	    PASSMSG(msg.str());	
	}
	else
	{
	    ostringstream msg;
	    msg << "Conversion Value for X4 UnitSystem is incorrect."
	...
	{
	    ostringstream msg;
	    msg << "Unit label for X4 UnitSystem is correct."
		<< endl;
	    PASSMSG(msg.str());	
	}
	else
	{
	    ostringstream msg;
	    msg << "Unit label for X4 UnitSystem is incorrect."
		<< endl << "\tThe value returned was " 
		<< uX4.Lname() << " != " << expValS << endl;
	    FAILMSG(msg.str());
	}
	...
	{
	    ostringstream msg;
	    msg << "Conversion Value for SI UnitSystem is correct."
		<< endl;
	    PASSMSG(msg.str());	
	}
	else
	{
	    ostringstream msg;
	    msg << "Conversion Value for SI UnitSystem is incorrect."
		<< endl << "\tThe value returned was " 
		<< uSI.M() << " != " << expVal << endl;
	    FAILMSG(msg.str());
	}
	...
	{
	    ostringstream msg;
	    msg << "Unit label for SI UnitSystem is correct."
		<< endl;
	    PASSMSG(msg.str());	
	}
	else
	{
	    ostringstream msg;
	    msg << "Unit label for SI UnitSystem is incorrect."
		<< endl << "\tThe value returned was " 
		<< uSI.Mname() << " != " << expValS << endl;
	    FAILMSG(msg.str());
	}
    }
...
void test_def_ctor()
{
	...
	{
	    ostringstream msg;
	    msg << "Time Conversion Value for Default UnitSystem is correct."
		<< endl;
	    PASSMSG(msg.str());	
	}
	else
	...
	{
	    ostringstream msg;
	    msg << "Time Unit label for Default UnitSystem is correct."
		<< endl;
	    PASSMSG(msg.str());	
	}
	else
	{
	    ostringstream msg;
	    msg << "Time Unit label for Default UnitSystem is incorrect."
		<< endl << "\tThe value returned was " 
		<< uDef.tname() << " != " << expValS << endl;
	    FAILMSG(msg.str());
	}
...
void test_more_accessors()
{
    ...
    {
	ostringstream msg;
	msg << "Electric Current Conversion Value for Default UnitSystem is correct."
	    << endl;
	PASSMSG(msg.str());	
    }
    else
    {
	ostringstream msg;
	msg << "Electric Current Conversion Value for Default UnitSystem is incorrect."
	    << endl << "\tThe value returned was " 
	    << myus.I() << " != " << expVal << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << " Electric Current Unit label for UnitSystem is correct."
	    << endl;
	PASSMSG(msg.str());	
    }
    else
    {
	ostringstream msg;
	msg << "Electric Current Unit label for UnitSystem is incorrect."
	    << endl << "\tThe value returned was " 
	    << myus.Iname() << " != " << expValS << endl;
	FAILMSG(msg.str());
    }
...
//---------------------------------------------------------------------------//
    ...
    {
	ostringstream msg;
	msg << "Angle Conversion Value for Default UnitSystem is correct."
	    << endl;
	PASSMSG(msg.str());	
    }
    else
    {
	ostringstream msg;
	msg << "Angle Conversion Value for Default UnitSystem is incorrect."
	    << endl << "\tThe value returned was " 
	    << myus.A() << " != " << expVal << endl;
	FAILMSG(msg.str());
    }
    ...
    {
	ostringstream msg;
	msg << " Angle Unit label for UnitSystem is correct."
	    << endl;
	PASSMSG(msg.str());	
    }
    else
    {
	ostringstream msg;
	msg << "Angle Unit label for UnitSystem is incorrect."
	    << endl << "\tThe value returned was " 
	    << myus.Aname() << " != " << expValS << endl;
	FAILMSG(msg.str());
    }
...
//---------------------------------------------------------------------------//
    ...
    {
	ostringstream msg;
	msg << "Quantity Unit label for UnitSystem is correct."
	    << endl;
	PASSMSG(msg.str());	
    }
    else
    {
	ostringstream msg;
	msg << "Quantity Unit label for UnitSystem is incorrect."
	    << endl << "\tThe value returned was " 
	    << myus.Qname() << " != " << expValS << endl;
	FAILMSG(msg.str());
    }
...
{   
	...
	{
	    ostringstream msg;
	    msg << "Length conversion failed. Found " 
		<< myL   << " " << uX4.Lname() << " = " 
		<< myLsi << " " << si.Lname()
		<< endl;
	    FAILMSG(msg.str());
	...
	{
	    ostringstream msg;
	    msg << "Mass conversion failed. Found " 
		<< myM   << " " << uX4.Mname() << " = " 
		<< myMsi << " " << si.Mname()
		<< endl;
	    FAILMSG(msg.str());
	...
	{
	    ostringstream msg;
	    msg << "Velocity conversion failed. Found " 
		<< myV   << " " << uX4.Lname() << "/" 
		<< uX4.tname() << " = " 
		<< myVsi << " " << si.Lname() << "/"
		<< si.tname() << endl;
	...
	{
	    ostringstream msg;
	    msg << "Acceleration conversion failed. Found " 
		<< mya   << " " << uX4.Lname() << "/" 
		<< uX4.tname() << "^2 = " 
		<< myasi << " " << si.Lname() << "/"
		<< si.tname() << "^2" << endl;
	...
	{
	    ostringstream msg;
	    msg << "Force conversion failed. Found " 
		<< myF   << " " << uX4.Mname() << "*" 
		<< uX4.Lname() << "/" 
		<< uX4.tname() << "^2 = " 
		<< myFsi << " " << si.Mname() << "*" 
	...
	{
	    ostringstream msg;
	    msg << "Energy conversion failed. Found " 
		<< myE   << " " << uX4.Mname() << "*" 
		<< uX4.Lname() << "^2/" 
		<< uX4.tname() << "^2 = " 
		<< myEsi << " " << si.Mname() << "*" 
	...
	{
	    ostringstream msg;
	    msg << "Power conversion failed. Found " 
		<< myP   << " " << uX4.Mname() << "*" 
		<< uX4.Lname() << "^2/" 
		<< uX4.tname() << "^3 = " 
		<< myPsi << " " << si.Mname() << "*" 
