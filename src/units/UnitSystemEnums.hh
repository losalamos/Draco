...
std::string const t_long_labels( "no time unit specified,second,milisecond,microsecond,shake,nanosecond");
...
double const T_cf[num_Ttype] = { 0.0, 1.0, 1.1604449278e7 };
