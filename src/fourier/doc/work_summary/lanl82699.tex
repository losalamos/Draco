...
\section{Future Work}
The Fourier analysis package has several future work items that are
going to be implemented in the near future.  The most important item
is the completion of the initial documentation associated with the
package.  Currently the documentation is in an uncompleted form.  To
make this a usable package the documentation must be completed.  The
second important future work item is the redistribution of behavior
within the code.  A new hierarchy has been formulated that makes the
code more flexible and increases the codes ease of use.   Finally 2D
Fourier analysis capability must be incorporated.  This final
implementation is very near completion. When these future work items 
have been completed the package will truly address all of the goals 
that were incorporated in the initial design.  
