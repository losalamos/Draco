...
int main( int argc, char *argv[] )
{
    ...
    if (passed) 
    {
        cout << "**** PoomaMesh_XYZ::nctf Self Test: PASSED ****" << endl;
    }
    else
    {
        cout << "**** PoomaMesh_XYZ::nctf Self Test: FAILED ****" << endl;
    }
    cout <<     "******************************************" << endl;
    cout << endl;

    cout << "Done testing PoomaMesh_XYZ::nctf.\n";
