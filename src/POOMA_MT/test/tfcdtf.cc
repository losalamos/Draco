...
int main( int argc, char *argv[] )
{
    ...
    if (passed) 
    {
        cout << "**** PoomaMesh_XYZ::fcdtf Self Test: PASSED ****" << endl;
    }
    else
    {
        cout << "**** PoomaMesh_XYZ::fcdtf Self Test: FAILED ****" << endl;
    }
    cout <<     "*******************************************" << endl;
    cout << endl;

    cout << "Done testing PoomaMesh_XYZ::fcdtf.\n";
