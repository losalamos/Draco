...
int main( int argc, char *argv[] )
{
    ...
    if (passed) 
    {
        cout << "**** PoomaMesh_XYZ::cctf Self Test: PASSED ****" << endl;
    }
    else
    {
        cout << "**** PoomaMesh_XYZ::cctf Self Test: FAILED ****" << endl;
    }
    cout <<     "******************************************" << endl;
    cout << endl;

    cout << "Done testing PoomaMesh_XYZ::cctf.\n";
