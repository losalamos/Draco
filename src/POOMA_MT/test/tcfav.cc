...
int main( int argc, char *argv[] )
{
	...
	{
	    cout << "Initiating test of the PoomaMesh_XYZ model of the MT "
		 << "connection faces arround vertex concept."
		 << endl;

	    TestMTConnFacesArroundVrtx<PoomaMesh_XYZFactory> tester(mtFactory, cout);
	    tester.run();
