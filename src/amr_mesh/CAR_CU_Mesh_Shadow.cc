//----------------------------------*-C++-*----------------------------------//
// CAR_CU_Mesh_Shadow.hh
// B.T. Adams (bta@lanl.gov)
// 21 Sept 99
//---------------------------------------------------------------------------//
// @> CAR_CU_Mesh_Shadow mesh class header file
//---------------------------------------------------------------------------//

#ifndef __mc_CAR_CU_Mesh_hh_Shadow__
#define __mc_CAR_CU_Mesh_hh_Shadow__

//===========================================================================//
// class CAR_CU_Mesh_Shadow - 
//
// Purpose : Provides a shadow object interface to the Continuous Adaptive 
// Refinement Cartesion Unstructured Mesh Class for use with Fortran programs.
//
// revision history:
// -----------------
//  0) original
...
#endif                          // __mc_CAR_CU_Mesh_Shadow_hh__

//---------------------------------------------------------------------------//
//                              end of mc/CAR_CU_Mesh_Shadow.hh
//---------------------------------------------------------------------------//
