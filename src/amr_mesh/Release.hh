 ...
 *    input file and a continuous adaptive refinement mesh file that uses the
 *    \ref rtt_format_defined (the latter file can be generated by the mesh 
 ...
 *    class object. While the Mat_State class object is actually in the 
