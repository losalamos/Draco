...
#ifndef __ConjGradDiffusionSolver_MatrixP1DiffTraits_hh__
#define __ConjGradDiffusionSolver_MatrixP1DiffTraits_hh__
...
template<class MT>
class MatrixFactoryTraits<rtt_ConjGradDiffusionSolver::MatrixP1Diff<MT> >
{
    ...
    typedef rtt_ConjGradDiffusionSolver::MatrixP1Diff<MT> Matrix;
...
#endif // __ConjGradDiffusionSolver_MatrixP1DiffTraits_hh__

//---------------------------------------------------------------------------//
// end of ConjGradDiffusionSolver/MatrixP1DiffTraits.hh
//---------------------------------------------------------------------------//
